...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const styles = {
      ...
      panel: {
        width: 400, maxWidth: 'calc(100vw - 32px)', height: 'min(620px, calc(100vh - 200px))',
        ...
        h(
          ...
          tab === 'all' &&
            h(
              'select',
              {
                style: { ...styles.sortSel, marginLeft: 'auto' },
                value: sort,
                onChange: (e) => setSort(e.target.value),
                title: '排序方式',
              },
              h('option', { value: 'time' }, '按更新时间'),
              h('option', { value: 'stars' }, '按星数'),
            ),
        ),
        h(
          'div',
